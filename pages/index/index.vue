<template>
  <view class="container">
    <view class="row">
      ...
      <view class="col-4 bg-red">
				<echarts :option="optionone" style="height:calc(100% - 1px);width:calc(100% - 1px);transform:rotate(90deg);"></echarts>
				<view style="transform:rotate(90deg);color: greenyellow;font-size: 16px;text-align: center">
					空气负离子指数
				</view>
			</view>

			<!--//右二栏位内容-->
      <view class="col-4 bg-green">
				<echarts :option="optiontwo" style="right: 0%; height:calc(100% - 1px);width:calc(100% - 1px);transform:rotate(90deg);"></echarts>
			...
			<!--//右三栏位内容-->
     <view class="col-4 bg-blue">
			 <view style="background-image: url('/static/human2.png');transform: rotate(-90deg) scale(1, -1); background-size:cover ; background-position: left center;height:216px;width: 200px;">
			 	<echarts :option="optionthree" style="height:calc(100% - 1px);width:calc(100% - 1px);transform: rotate(180deg) scale(1, -1);"></echarts>
			 </view>
				<view style="transform:rotate(90deg);color: greenyellow;font-size: 16px;text-align: center">
					人体部位频率
				</view>
    ...
    <view class="row">
			<view class="col-12 bg-yellow">
  		<!-- <view style="transform:rotate(90deg);"><text style="color:'#e82107'">左</text></view> -->
  		<echarts :option="option"  style="height:calc(100% - 1px);width: calc((100% - 1px));"></echarts>
            ...
            series: [
                {
                    ...
                    data: [{value:random, name: '负离子'}],           //  表盘中央显示的值和字
                    min:0,
                    ...
                    axisLine: {            // 坐标轴线 色块
                        lineStyle: {       // 属性lineStyle控制线条样式
                            width: 15,
                            color: [[0.2, '#e82107'], [0.5, '#f7ad1d'] , [1, '#55ff00']]       //  此处是将表盘分成的块数，0-1之间的小数，后面的颜色是每块的背景色
                        }
                    },
                    axisLabel:{
											  color:'#55ff00',
		...
		logstatrt() {
			  ...
			  dyndata=[parseInt(Math.random() * (100-60+1)+60),parseInt(Math.random() *  (100-60+1)+60),
				...
				this.option = {
					...
					legend: {
						orient: 'horizontal', left: 'auto', top:'top',icon:'rect',
